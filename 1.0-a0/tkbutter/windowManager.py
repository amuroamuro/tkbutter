...
class WindowManager:
    ...
    #위젯 매니저
    def create_label(self, frame_number: int=0, text: str="Do you want some BUTTER?", font=Font()):
        wizet_number = len(self.__wizet_list)
        self.__wizet_list.append(Label(self.__frame_list[frame_number], text=text, font=font))
