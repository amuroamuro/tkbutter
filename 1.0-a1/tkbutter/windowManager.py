...
class WindowManager:
    ...
    def create_label(self, frame_number: int=0, text: str="Do you want some BUTTER?", font_number: int=0):
        ...
        self.__wizet_list.append(Label(self.__frame_list[frame_number], text=text, font=self.__font_list[font_number]))
        return wizet_number

    def create_button(self, frame_number, text: str="Do you want some BUTTER?", commend: Callable[..., Any]=print("Do you want some BUTTER?"), font_number: int=0):
        wizet_number = len(self.__wizet_list)
        self.__wizet_list.append(Button(self.__frame_list[frame_number], text=text, command=commend, font=self.__font_list[font_number]))
